        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-400 mt-0.5 max-w-2xl">
              Claude evaluates the entire timestamped transcript to detect top viral moments, high-retention hooks, and complete standalone stories.
            </p>
          </div>
        </div>
          ...
          >
            {isAnalyzing ? (
              <>
                ...
                <span>Claude Finding Viral Clips...</span>
              </>
            ) : hasClips ? (
              <>
                <Sparkles className="w-4 h-4" />
                <span>Re-Analyze Transcript</span>
              </>
            ) : (
              <>
